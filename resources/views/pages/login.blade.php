...
<div class="min-h-[75vh] flex items-center justify-center py-10 px-4 sm:px-6">
    ...
    <div class="relative w-full max-w-lg">
        <div class="absolute -top-10 -left-10 w-64 h-64 bg-amber-400/20 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute -bottom-10 -right-10 w-64 h-64 bg-amber-600/15 rounded-full blur-3xl pointer-events-none"></div>

        <!-- Centered Glass Card Container (Clean, Image-Free) -->
        <div class="relative bg-white/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-amber-200/60 p-8 sm:p-12 overflow-hidden">
